...
async function testNdengoBrutalizer() {
    ...
    await resolveDiscovery(choiceA);
...
function testDecayedSale() {
    ...
    sellCard(decayed.id);
    assert.strictEqual(state.player.gold, 3, "Decayed creature sold for 0 gold");
